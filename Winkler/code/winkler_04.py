...
do_files =sorted(glob('/Users/jung-ok/work1/'+cruise+'/processed/Winkler/LAB/dissolved*.csv'))
...
fname = '/Users/jung-ok/work1/'+cruise+'/processed/Winkler/LAB/DO_Winkler_CTD_'+cruise+st+'.csv'
