...
do_files =sorted(glob('/Users/jung-ok/work1/ANA13B/processed/Winkler/LAB/dissolved*.csv'))

cruise=do_files[i].split('/')[-1].split('.')[0][-9:-3]
st=do_files[i].split('/')[-1].split('.')[0][-3:]
...
file_name = '/Users/jung-ok/work1/ANA13B/plot/Winkler/LAB/'+'linear regression'+'_winkler_ctd_'+cruise+st+'.png'
