...
# skiprows=245
df= pd.read_csv(old_folder+fname, 
    skiprows=245, index_col=None, header=None, delimiter=r"\s+")    
...
# print(result[['Date-Time', 'Bottle', 'Depth [salt water, m]', 'Oxygen, SBE 43 [umol/kg]']].head())
